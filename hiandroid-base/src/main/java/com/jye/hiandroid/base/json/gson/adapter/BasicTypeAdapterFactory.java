package com.jye.hiandroid.base.json.gson.adapter;
...
import com.jye.hiandroid.base.json.gson.util.GsonReadUtils;
import com.jye.hiandroid.util.HiStringUtils;
                    ...
                    switch (type) {
                        case 0:
                            if (in.peek() == JsonToken.STRING) {
                                //暂不做处理
                                return HiStringUtils.toInt(in.nextString());
                            }
                            return in.nextInt();
                        case 1:
                            if (in.peek() == JsonToken.STRING) {
                                //暂不做处理
                                return HiStringUtils.toLong(in.nextString());
                            }
                            return in.nextLong();
                        case 2:
                            if (in.peek() == JsonToken.STRING) {
                                //暂不做处理
                                return HiStringUtils.toInt(in.nextString()).shortValue();
                            }
                            return (short) in.nextInt();
                        case 3:
                            if (in.peek() == JsonToken.STRING) {
                                //暂不做处理
                                return HiStringUtils.toDouble(in.nextString());
                            }
                            return in.nextDouble();
                        case 4:
                            if (in.peek() == JsonToken.STRING) {
                                //暂不做处理
                                return HiStringUtils.toFloat(in.nextString());
                            }
